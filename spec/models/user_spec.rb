...
describe User do
  ...
  describe "when email format is invalid" do
    it "should be invalid" do
      adresses = %w[user@foo,com user_at_foo.org user@foo..com example.user@foo.foo@bar_baz.com foo@bar+baz.com]
  ...
  describe "email adress with mixed case" do
    let(:mixed_case_adress) { "ExaMple@exaMPle.coM" }
    it "should be saved as all lower-cased" do
      @user.email = mixed_case_adress
      @user.save
      expect(@user.reload.email).to eq mixed_case_adress.downcase
    end
  end
